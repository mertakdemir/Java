...
public class Runner {
    ...
    public static void main(String[] args) {
        ...
        /*
        1)Relationships from "parent" to "child" is called "Has-A" Relationship.
        2)Relationships from "child" to "parent" is called "Is-A" Relationship.
         */
        ...
        5)"this" is used to calla data(variables+ methods) from the class itself
        ...
        /*
          ...
          Note: If the method is "final", it means its body cannot be updated.

          11)Body of "final method" cannot be updated, because in Overriding we change the method
