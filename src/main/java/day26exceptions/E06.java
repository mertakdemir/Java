...
public class E06 {
    ...
    public static void main(String[] args) {
        ...
        //doCombo(null, 2);//str.length(); will throw NullPointerException, execution will be stopped

        //doCombo("12a", 2);//Integer.valueOf(); will throw NumberFormatException, execution will be stopped

        //doCombo("420", 0);//intStr/num; will throw ArithmeticException, execution will be stopped
