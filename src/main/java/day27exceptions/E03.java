...
public class E03 {
    ...
    /*
       1) 1)"FileNotFoundException" is related with the "Path of the file" and the "Existence of the file".
    ...
    public static void readTheText() throws IOException {
        ...
        FileInputStream fis = new FileInputStream("src\\main\\java\\day27exceptions\\File01.txt");
